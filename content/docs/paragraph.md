...
hero:
  ...
  ctas:
    ...
    - text: Page code on Github
      url: https://raw.githubusercontent.com/Hugolify/hugolify-example-blocks/refs/heads/main/content/docs/paragraph.md
      blank: true
      link: true
  ui:
    theme: light
...
blocks:
  ...
  - type: paragraph
    ui:
      grid: container
    surtitle: Grid container / No theme
    ...
    text: >-
      ...
      sed convallis purus posuere a. Proin ullamcorper, elit in cursus
      facilisis, nulla neque convallis libero, nec aliquet lorem ante non
      eros. Sed convallis enim placerat volutpat molestie. Etiam dictum dictum
      purus, vitae sagittis urna condimentum quis.
      

      Aliquam mattis sapien vitae magna aliquet malesuada. Pellentesque
      fringilla eros eu blandit consequat. Nulla nisl ipsum, venenatis sit amet
      risus ut, dictum pellentesque dui. Maecenas velit dolor, volutpat vel
      laoreet in, lacinia quis sem.
    ctas:
      - url: /
        text: CTA text
  - type: paragraph
    ui:
      grid: large
      offset: center
    surtitle: Grid large / Offset center / No theme
    title: Quisque eget magna nec nunc scelerisque posuere nec at eros.
    text: >-
      Quisque eget magna nec nunc scelerisque posuere nec at eros. Nulla
      placerat ipsum pulvinar mauris lacinia, vel consectetur sem
  ...
  - type: paragraph
    ui:
      grid: medium
      offset: center
    surtitle: Grid medium / Offset center / No theme
    title: Quisque eget magna nec nunc scelerisque posuere nec at eros.
    text: >-
      Quisque eget magna nec nunc scelerisque posuere nec at eros. Nulla
      placerat ipsum pulvinar mauris lacinia, vel consectetur sem
  ...
  - type: paragraph
    ui:
      grid: small
      offset: center
    surtitle: Grid small / Offset center / No theme
    title: Quisque eget magna nec nunc scelerisque posuere nec at eros.
    text: >-
      Quisque eget magna nec nunc scelerisque posuere nec at eros. Nulla
      placerat ipsum pulvinar mauris lacinia, vel consectetur sem
  ...
  - type: paragraph
    ui:
      ...
      align: center
      theme: accent
    surtitle: Grid medium / Offset center / Theme accent / Align center
    title: Quisque eget magna nec nunc scelerisque posuere nec at eros.
    text: >-
      Quisque eget magna nec nunc scelerisque posuere nec at eros. Nulla
      placerat ipsum pulvinar mauris lacinia, vel consectetur sem
  ...
  - type: paragraph
    ui:
      ...
      offset: center
      theme: light
    surtitle: Grid large / Offset center / Theme light / Without text
    title: Quisque eget magna nec nunc scelerisque posuere nec at eros.
    ctas:
      - url: /
        text: CTA text
  ...
  - type: paragraph
    ui:
      ...
      offset: center
      theme: highlight
    surtitle: Grid large / Offset center / Theme highlight / Without text
    title: Quisque eget magna nec nunc scelerisque posuere nec at eros.
    ctas:
      - url: /
        text: CTA text
  - type: paragraph
    ui:
      ...
      offset: center
      theme: accent
    surtitle: Grid large / Offset center / Theme accent
    title: Quisque eget magna nec nunc scelerisque posuere nec at eros.
    text: >-
      Quisque eget magna nec nunc scelerisque posuere nec at eros. Nulla
      placerat ipsum pulvinar mauris lacinia, vel consectetur sem
  ...
  - type: paragraph
    ui:
      ...
      offset: center
      theme: accent
    surtitle: Grid large / Offset center / Theme accent / Without text
    title: Quisque eget magna nec nunc scelerisque posuere nec at eros.
    ctas:
      - url: /
        text: CTA text
  ...
  - type: paragraph
    ui:
      ...
      offset: center
      theme: light
    surtitle: Grid large / Offset center / Theme light / With notes
    title: Quisque eget magna nec nunc scelerisque posuere nec at eros.
    text:
